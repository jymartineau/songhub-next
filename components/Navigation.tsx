                ...
                <Dialog.Panel className="relative flex w-full max-w-xs flex-1 flex-col bg-gray-800">
                  ...
                  <div className="h-0 flex-1 overflow-y-auto pt-5 pb-4">
                    <div className="flex flex-shrink-0 items-center px-4">
                     <p className='text-lg font-black'>SH</p>
                    </div>
        ...
        <div className="hidden lg:fixed lg:inset-y-0 lg:flex lg:w-64 lg:flex-col">
          ...
          <div className="flex min-h-0 flex-1 flex-col bg-gray-800">
            <div className="flex flex-1 flex-col overflow-y-auto pt-5 pb-4">
              <div className="flex flex-shrink-0 items-center px-4">
                <div
                  className="h-10 flex w-10 bg-gray-600 rounded-full"
                            
                ><p className='w-full h-full text-center '>SH</p></div>
              </div>
              ...
              <a href="#" className="group block w-full flex-shrink-0">
                <div className="flex items-center">
                  ...
                  <div className="ml-3">
                    ...
                    <Link href='/api/auth/logout'><p className="text-xs font-medium text-gray-300 group-hover:text-gray-200">View profile</p></Link>
